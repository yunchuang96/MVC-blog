<?php
/* Smarty version 3.1.29, created on 2017-06-14 02:39:36
  from "D:\xampp\htdocs\total\my_blog\Application\Back\VIEW\Manage\index.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_594085c8620043_53457435',
  'file_dependency' => 
  array (
    'c4eaf2743ebef6df28971767508b46ec6aa14760' => 
    array (
      0 => 'D:\\xampp\\htdocs\\total\\my_blog\\Application\\Back\\VIEW\\Manage\\index.html',
      1 => 1491806720,
      2 => 'file',
    ),
  ),
...
function content_594085c8620043_53457435 ($_smarty_tpl) {
...
次登录<br>上次登录时间为<?php echo smarty_modifier_date_format($_SESSION['adminInfo']['login_time'],'%Y-%m-%d');?>
<br>上次登录的IP为<?php echo $_SESSION['adminInfo']['login_ip'];?>
</div>
            </div>
            <br />
        	<div class="panel">
        ...
        <div class="xm9">
            ...
            <div class="panel">
                ...
                <table class="table">
                    ...
                    <tr><td width="110" align="center">操作系统：</td><td><?php echo @constant('PHP_OS');?>
</td><td width="90" align="right">系统开发：</td><td><a href="#" target="_blank">ICFrame框架</a></td></tr>
                    <tr><td align="center">Web服务器:</td><td><?php echo $_SERVER['SERVER_SOFTWARE'];?>
</td><td align="right">主页：</td><td><a href="#" target="_blank">#</a></td></tr>
                    <tr><td align="center">服务器IP：</td><td><?php echo $_SERVER['SERVER_ADDR'];?>
</td><td align="right">演示：</td><td><a href="#" target="_blank"></a></td></tr>
                    <tr><td align="center">数据库:</td><td>MySQL</td><td align="right">群交流：</td><td><a href="#" target="_blank">12345678</a> (点击加入)</td></tr>
                </table>
            </div>
        </div>
    </div>
    <p class="text-right text-gray">基于<a class="text-gray" target="_blank" href="#">MVC框架</a>构建
</div>
</body>
</html><?php }
}
